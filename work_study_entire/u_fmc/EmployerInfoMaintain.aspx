...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <legend class="text-center text-primary">用人单位信息管理</legend>
    ...
    <div id="first" class="auto-style7"> 
        ...
        <asp:GridView ID="GridView1" runat="server" 
            ...
            <Columns>
                <asp:BoundField DataField="EmployerId" HeaderText="用人单位号" ReadOnly="True" />
                <asp:BoundField DataField="EmployerName" HeaderText="单位名" />
                <asp:BoundField DataField="EmployerSite" HeaderText="办公地点" />
        ...
        <p> &nbsp;</p>
            ...
            <asp:Button ID="Button3" style="margin-left:15px" class="btn btn-primary"  data-loading-text="导出" type="button" runat="server" OnClick="Button3_Click" Text="导出至excel" />
            </ContentTemplate>
        <Triggers>
	...
	<div class="row clearfix">
		<div class="col-md-12 column" >
			<button id="modal-874515"  href="#modal-container-874515" role="button" type="button" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-user"></span>添加用人单位信息</button>
     ...
     <tr>
     <td style="width: 100px; text-align: right"> 用人单位编号：</td>
     <td class="auto-style6"> 
     <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox></td> 
     </tr>
     <tr>
     <td style="width: 100px; text-align: right"> 单位名：</td>
     <td class="auto-style6">
     <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox></td> 
     </tr>
     <tr>
     <td style="width: 100px; text-align: right">  办公地点：</td>
     <td class="auto-style6">
