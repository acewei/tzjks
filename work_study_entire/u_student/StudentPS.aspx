...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p>
       ...
       <%--<asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="TextBox1" Display="Dynamic" Enabled="False" ErrorMessage="以yyyy-m-d格式输入一个日期" OnServerValidate="CustomValidator1_ServerValidate" ValidationGroup="AllValidators"></asp:CustomValidator> --%> 
        &nbsp;&nbsp;
